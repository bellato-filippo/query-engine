...
object Main extends App {
  ...
  val cq2: Query = Query(2, Head(List()), Set(Atom("R", List(Variable("y"), Variable("z"))), Atom("R", List(Variable("x"), Variable("y"))), Atom("R", List(Variable("z"), Variable("x"))), Atom("R", List(Variable("z"), Variable("s")))))
